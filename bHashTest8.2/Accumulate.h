...
#ifndef BHASHTEST8_0_ACCUMULATE_H
#define BHASHTEST8_0_ACCUMULATE_H
...
public:
    ...
    Accumulate(int sub_file_num, uint64_t bucket_num, int accumulate_num, uint64_t bucket_num_small);
    ...
    int transvert_accumulate(int file_no);
...
#endif //BHASHTEST8_0_ACCUMULATE_H
