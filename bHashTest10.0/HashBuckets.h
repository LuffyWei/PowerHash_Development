...
public:
    ...
    HashBuckets(uint64_t bucket_num, int sub_file_num, int KV_buffer_num, uint64_t buffer_size_B);
    ...
    int fill_hash_buckets(CountMin*countMin, Accumulate*accumulate,  string base_path, string k, string v, char kv_split, uint64_t frequency_threshold);
