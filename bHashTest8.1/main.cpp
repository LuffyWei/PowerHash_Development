...
void group_by(string input_path, string base_path, int count_min_num, uint64_t count_min_length,
    ...
    /********************读取key文件，然后填充hash表*********************************/
    Accumulate *accumulate = new Accumulate(sub_file_num, bucket_num, accumulate_num);
...
//    fstream out_1;
//    string out_1_path = "/home/weixun/CLionProjects/bHashTest7.3/data/key_s";
...
//    string default_path = "/home/weixun/KV data/wiki";
    ...
    string base_path = "/home/weixun/CLionProjects/bHashTest8.1/data";
    //count-min的三个参数
    int count_min_num = 3;
    ...
    uint64_t frequency_threshold = 30;
